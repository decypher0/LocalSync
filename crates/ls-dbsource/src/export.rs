...
use mysql::{Column, Conn, OptsBuilder, Row, Value};
use std::fmt::Write as _;
use std::time::Duration;

/// Same reasoning as `connect::CONNECT_TIMEOUT`: a network leg to the
/// developer's database must fail in single-digit seconds, never hang.
